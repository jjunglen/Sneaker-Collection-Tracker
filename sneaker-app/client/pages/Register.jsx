    ...
    return (
        <section className="flex items-center justify-center p-12 min-h-screen">
            <div className="bg-white border border-gray-400 shadow-[4px_4px_0px_#4CAF82] rounded-xl w-full max-w-3xl p-10">
                ...
                <p className="text-slate-400 mb-8 text-sm">Start tracking your collection</p>
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <div className="flex flex-col gap-1">
                        <label className="font-bold text-sm text-blue-950">Username</label>
                        <input 
                            type="text"
                    ...
                    {/* Password section */}
                    <div className="flex flex-col gap-1">
                        <label className="font-bold text-sm text-blue-950">Password</label>
                        <input 
                            type="password"
                    ...
                    <div className="flex flex-col gap-1">
                        <label className="font-bold text-sm text-blue-950">Confirm Password</label>
                        <input 
                            type="password"
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="mt-2 w-full bg-blue-950 text-white text-sm font-medium py-3 rounded-lg shadow-[4px_4px_0px_#4CAF82] hover:-translate-y-0.5 hover:shadow-2xl transition-all duration-200 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                {/* Footer */}
                <p className="text-center mt-5 text-center text-sm text-slate-500">
